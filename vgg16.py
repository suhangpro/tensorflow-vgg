...
class Vgg16:
    ...
    def build(self, rgb, summary=False, weight_decay=0.0, train=False):
        ...
        self.pool3 = self.max_pool(self._conv3_3, 'pool3')
        self.conv3, self.conv3_params = self._conv3_3, self._conv3_1_params + self._conv3_2_params + self._conv3_3_params
        ...
        self.pool4 = self.max_pool(self._conv4_3, 'pool4')
        self.conv4, self.conv4_params = self._conv4_3, self._conv4_1_params + self._conv4_2_params + self._conv4_3_params
